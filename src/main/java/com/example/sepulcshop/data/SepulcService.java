...
public class SepulcService {
    ...
    @Autowired
    public SepulcService(SepulcRepository sepulcRepository) {
        this.sepulcRepository = sepulcRepository;
    }

    public List<Sepulc> getSepulcData() {

        return sepulcRepository.findAll();
    }
...
//        {
//            Sepulc sepulc = new Sepulc(sepulcRepository);
...
//            sepulc.setImagePath(rs.getString("image_path"));
//            return sepulc;
//        });
//
